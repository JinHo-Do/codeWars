// https://www.codewars.com/kata/palindromic-numbers/train/javascript
//
...
function palindromize(number){
  ...
  if (numArr.length === 1) return '0 ' + number;

  while (true) {
    count++;
    numArr = (+numArr.join('') + +numArr.reverse().join('')).toString(10).split('');
